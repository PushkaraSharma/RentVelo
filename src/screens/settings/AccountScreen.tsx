...
import { View, Text, StyleSheet, Pressable, ScrollView, Image, Share, Modal, ActivityIndicator } from 'react-native';
        ...
        <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
            ...
            <Modal visible={isDeleting} transparent={true} animationType="fade">
                <View style={styles.loaderOverlay}>
                    ...
                    <Text style={styles.loaderText}>Permanently Wiping Data...</Text>
